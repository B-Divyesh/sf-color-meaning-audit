const CACHE = 'signal-check-site-v6';
const SHELL = [
  '/',
  '/demo/',
  '/install/',
...
<body class="demo-page">
  ...
  <footer class="site-footer wrap"><div><a class="brand" href="/">Signal Check</a><p>Checks color-only signals on the visible page.</p></div><nav aria-label="Footer"><a href="/privacy/">Privacy</a><a href="/terms/">Terms</a></nav><p class="generated-note">Built by Param Factory · build 1.0.6</p></footer>
