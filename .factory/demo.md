...
After its first visit, the service worker can reload the sample warning and privacy banner while offline. Reset and model controls need an online page load.
